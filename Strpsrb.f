...
c      READ (9,*) NLEV
c      READ (9,*) (PRESS(I),I=1,NLEV)
cC      WRITE(*,*) PRESS
c      NLAY = NLEV - 1
c      CLOSE (9)
      NLEV = 31
!      PRESS = (/1.01, 1.59, 3.05, 6.0, 12.2, 25.7, 30.0, 35.0, 40.9,
!     & 48.0, 56.5, 66.6, 78.9, 93.7, 111.0, 132.0, 156.0,
!     & 182.0, 213.0, 247.0, 286.0, 329.0, 378.0, 432.0, 492.0,
!     & 559.0, 633.0, 715.0, 805.0, 904.0, 1025.0/)
      PRESS(1) = 1.01D0
      PRESS(2) = 1.59
      PRESS(3) = 3.05
      PRESS(4) = 6.0
