...
!     SFCALB  : surface albedo (0/1)
!     VIS     : visibility at ground station [km]
!     THETA   : zenith angle (o)
!     ICLOUD  : cloud parameter
!              0 - no clouds
!              1 - calculation with clouds
!     IWP     : cloud droplet size distribution
!     ISUB    : use subroutine WOLKE1 (ISUB=1) or WOLKE2 (ISUB=2)
!     TAUW    : cloud optical thickness
!              0.0 - no clouds 
!              100.0 - with clouds 
!     TOP     : cloud top (mbar)
!     NCL     : number of cloud layers
!     INTVAL  : spectral interval
!     INTVA   : value of the begin of spectral interval
!     INTVE   : value of the end of spectral interval
!     WH2O    : precipitable water [cm]
!     CLOLWC  : cloud liquid water content
!     CDR     : change degrees to radians
!     TRANS   : parameterized sky transmittance for broadband solar radiation 
!              in the atmosphere 
!     INDEX   : index of spectral intervals
!     NLEV    : number of atmosphere levels
!     SOL     : solar constant for each spectral interval
!     DZ      : thickness of each atmospheric layer
!     ROL     : air density
!     ROH     : water content (humidity)
!     RO3     : ozone content 
!     NLAY    : number of atmospheric layers
!     IH      : data for index of spectral intervals
...
!     DOWN    : global irradiation (Wh/m2)
!     DIRS    : direct irradiation (Wh/m2)
!     DIFS    : diffuse irradiation (Wh/m2)
!     IBEG    : begin of spectral interval
!     ISTO    : end of spectral interval
!     IALL    : counter of spectral interval
!     IDO     : flag to execute the loop of spectral intervals
!     NLA     : NLEV-1
!     NLY     : NLAY-1
!     ALDIF   : surface albedo for cloudy sky
!     ALDR    : surface albedo for clear sky
!     COSZEN  : cossine of zenith angle
!     LEVMAX  : maximum number of atmopheric levels
!     LAYMAX  : maximum number of atmopheric layers
!     MAXWEL  : number of spectral intervals
!     MAXIND  : number of spectral intervals including their subdivisions
!     IDO     :
!     BET     :
!     BET0    :
!     OM      :
...
!     ISOL    : 
!     WEIGHT  :
!     FITTOP  : top of aerosol profile (km)
!     FITBOT  : bottom of aerosol profile (km)
!     JTOP    :
!     JBOT    :
!     H       : altitude of aerosol profile (km)
!     DLAY    : delta of atmospheric layer (km)
!     SCATOP :
!     SCABOT :
!     CSCAL   :
!     ZJ      : altitude (km)
...
!.....................................................................
!      calculate aerosol-profiles for a given surface visibility
!      Load Aerosol-Profile (M! Clatchey with surface visibility=50km)
...
!......................................................................
     ...
     &   0.0920,   0.1320,   0.0620,   0.0230,113*0.0000 /
...
!
      ...
      DATA (QS(I),I=1,6) /19.D0,14.D0,3.5D0,9.1D0,1.2D0,14.D0/
     ...
     &  0.558D0,0.421D0,0.278D0,0.172D0,0.110D0,0.0D0/
      DATA (PS(I),I=1,6) /1013.D0,1013.D0,1018.D0,1010.D0,1013.D0,1013.D0/
      DATA (PMIN(I),I=1,6) /110.99D0,152.99D0,117.79D0,124.99D0,110.29D0,152.99D0/
      DATA (QCONST(I),I=1,6) /3.25D-06,5*4.0D-06/
