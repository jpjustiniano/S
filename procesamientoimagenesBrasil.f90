...
!Canal 4_ID: [430, 1368]
 ...
 character (40) :: filename  ! Nombres dentro de la lista
 character (80) :: filenamepathin
 character (40) :: pathin, pathout  ! Nombres dentro de la lista
...
filenamepathin = trim(pathin)//trim(filename)
 ...
 minu=string(11:12)
 foto=string(18:27)
 READ (ano,'(F4.0)', IOSTAT=errorread) iano
 If (errorread /=0) print *, ' Problema en lectura de lista!! Revisar lista: ', trim(filename)
 READ (mes,'(F2.0)') imes
 READ (cdia,'(F2.0)') idia
